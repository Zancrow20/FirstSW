...
public class DBLogic
{
    public static List<Account> GetUsers(string connectionString)
    {
        ...
        string sqlExpression = "SELECT * FROM AnimeDB.Accounts";
    ...
    public static Account GetUserById(string connectionString,int id)
    {
        ...
        string sqlExpression = $"SELECT * FROM AnimeDB.Accounts u where u.id = {id}";
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            connection.Open();
    ...
    public static void SaveUser(string connectionString,string nickname, string password)
    {
        ...
        string sqlExpression = "INSERT INTO AnimeDB.Accounts (nickname, password) VALUES (@nickname, @password)";
