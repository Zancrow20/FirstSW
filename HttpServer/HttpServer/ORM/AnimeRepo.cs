...
public class AnimeRepo : IRepository<Anime>
{
    ...
    public async Task<Anime> GetEntityByProperties(params object[] properties)
    {
        throw new NotImplementedException();
    }

    public async Task<IEnumerable<Anime>> GetLike(string query)
